  ...
  return (
    <section id="matriculas" className="py-20 md:py-40 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="bg-brand-navy rounded-[3rem] md:rounded-[5rem] p-8 md:p-32 text-white overflow-hidden relative border-[8px] md:border-[16px] border-brand-offwhite shadow-3xl">
          ...
          <div className="relative z-10">
            <ScrollReveal className="text-center mb-16 md:mb-32">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-[5rem] font-black mb-6 md:mb-10 tracking-tighter leading-tight md:leading-none">A jornada de excelência começa aqui.</h2>
              <p className="text-white/40 max-w-2xl mx-auto text-base md:text-xl font-light leading-relaxed px-2">
                  ...
                  {ENROLLMENT_STEPS.map((step, idx) => (
                    <div key={idx} className="flex gap-6 md:gap-10 group">
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl md:rounded-[2rem] border-2 border-brand-red/30 flex items-center justify-center font-black text-lg md:text-xl text-brand-red shrink-0 group-hover:bg-brand-red group-hover:text-white group-hover:scale-110 transition-all duration-500">
                          {idx + 1}
                        </div>
                      ...
                      <div className="pb-8 md:pb-10 transition-transform duration-500 group-hover:translate-x-2">
                        <h5 className="font-bold text-lg md:text-2xl mb-2 md:mb-3 text-white tracking-tight group-hover:text-brand-red transition-colors">{step.title}</h5>
                        <p className="text-white/40 text-sm md:text-lg leading-relaxed font-light">{step.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-3xl rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-16 border border-white/10 shadow-3xl transform transition-transform duration-500 hover:scale-[1.02]">
                  ...
                  <div className="text-center">
                    <button 
                      ...
                      className="group relative w-full bg-brand-red text-white py-5 md:py-8 rounded-full font-black text-lg md:text-2xl shadow-[0_20px_40px_-10px_rgba(230,57,70,0.5)] transition-all hover:scale-105 active:scale-95 mb-6 md:mb-8 btn-shimmer flex items-center justify-center gap-2 md:gap-3"
                    >
                      RESERVAR MATRÍCULA
